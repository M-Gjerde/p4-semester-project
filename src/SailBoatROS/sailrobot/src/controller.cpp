...
//Changed isSetup to true to begin control loop.... --> dunno why I had to.
Controller::Controller(std::string name, int looprate, int controller) : name(name), looprate(looprate), controller(controller), rudderAngle(0), sailAngle(0), xbeeMode(0), isSetup(true), beginLoop(false){
...
void Controller::loop(){
    //std::cout << "loop isSetup: " << isSetup << "loop beginLoop: " << beginLoop << std::endl;
